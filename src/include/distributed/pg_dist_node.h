...
#define Anum_pg_dist_node_nodename 2
#define Anum_pg_dist_node_nodeport 3
#define Anum_pg_dist_node_noderole 4
#define Anum_pg_dist_node_nodeactive 5
#define Anum_pg_dist_node_groupid 6
